<template>
  <div class="Debug">
    <table class="Debug__table">
      ...
      <tr class="Debug__table--row">
        <td class="Debug__table--row-cell" colspan="4">Envelope</td>
      </tr>
      <tr class="Debug__table--row" v-for="test in envelope" :key="test.validator">
      ...
      <tr class="Debug__table--row">
        <td class="Debug__table--row-cell" colspan="4">Common</td>
      </tr>
      <tr class="Debug__table--row" v-for="test in common" :key="test.validator">
        <td class="Debug__table--row-cell">{{ test.validator }}</td>
        <td class="Debug__table--row-cell">{{ test.example }}</td>
        <td class="Debug__table--row-cell">{{ test.status }}</td>
        <td class="Debug__table--row-cell">
